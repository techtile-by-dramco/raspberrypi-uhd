# Installation guide UHD on RPI 4 & 5 [Update 2025-11-05]
...
OR run following code to check automatically:
```bash
python3 - <<'EOF'
import os, sys
try:
